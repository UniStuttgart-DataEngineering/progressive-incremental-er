...
class BlockSizePrioritizer2(size1: Int, size2: Int = 0, ro: Float = 0.005f, ff: Float = 0.01f) {

  val ccer = Config.ccer

  println("BlockSizePrioritizer2: without TokenNGrams")
