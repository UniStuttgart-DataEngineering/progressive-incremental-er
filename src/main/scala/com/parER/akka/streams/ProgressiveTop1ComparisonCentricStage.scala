...
class ProgressiveTop1ComparisonCentricStage(name: String, size1: Int, size2: Int = 0, ro: Float = 0.005f, ff: Float = 0.01f, noUpdate: Boolean = false) extends GraphStage[FlowShape[(Int, TokenNGrams), Message]] {
      ...
      setHandler(in, new InHandler {
        ...
        override def onPush(): Unit = {
          ...
          if (comps.size > 0) {
            ...
            t0 = System.currentTimeMillis()
            comps = compRanker.getTopComparison()
