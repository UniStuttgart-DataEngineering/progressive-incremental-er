...
import com.parER.core.ranking.WNP2CBSMaxRanker
...
class ProgressiveCBSMaxComparisonCentricStage(name: String, size1: Int, size2: Int = 0, ro: Float = 0.005f, ff: Float = 0.01f, noUpdate: Boolean = false) extends GraphStage[FlowShape[(Int, TokenNGrams), Message]] {
  val in = Inlet[(Int, TokenNGrams)]("ProgressiveCBSMaxComparisonCentricStage.in")
  val out = Outlet[Message]("ProgressiveCBSMaxComparisonCentricStage.out")
  ...
  override def createLogic(attr: Attributes): GraphStageLogic =
    new GraphStageLogic(shape) {
      ...
      val compCleaner = new WNP2CBSMaxRanker
      //new WNP2CompCleaner//ComparisonCleaning.apply(Config.ccMethod)
