...
import com.parER.core.prioritizing.Prioritizing
...
class AbstractProgressivePerProvareCentricStage(rankMethod: String, progressiveMethod:String, size1: Int, size2: Int = 0, ro: Float = 0.005f, ff: Float = 0.01f, noUpdate: Boolean = false) extends GraphStage[FlowShape[(Int, TokenNGrams), Message]] {
    ...
    new GraphStageLogic(shape) {
      ...
      setHandler(in, new InHandler {
        ...
        override def onPush(): Unit = {
          ...
          //var comps = compGeneration.progressiveComparisons(tuple._1, tuple._2, tuple._3)
