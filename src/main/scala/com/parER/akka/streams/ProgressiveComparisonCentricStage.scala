...
import com.parER.core.blocking.{BlockGhosting, CompGeneration, CompGenerationFun, EntityTokenBlockerRefiner, StoreModel, TokenBlockerRefiner}
import com.parER.core.compcleaning.{GlobalHSCompCleaner, WNP2CompCleaner}
...
class ProgressiveComparisonCentricStage(name: String, size1: Int, size2: Int = 0, ro: Float = 0.005f, ff: Float = 0.01f, noUpdate: Boolean = false) extends GraphStage[FlowShape[(Int, TokenNGrams), Message]] {
    ...
    new GraphStageLogic(shape) {
      ...
      setHandler(in, new InHandler {
        ...
        override def onUpstreamFinish(): Unit = {
          ...
          while ( false && !compRanker.isEmpty()) {
          ...
          while (false && !ranker.isEmpty(0) && !ranker.isEmpty(1)) {
